...
export async function middleware(request) {
  ...
  const isPublicPage = pathname.startsWith('/agb') || pathname.startsWith('/datenschutz') || pathname.startsWith('/impressum') || pathname.startsWith('/widerruf') || pathname.startsWith('/angebote') || pathname.startsWith('/gehaltsverhandlung') || pathname.startsWith('/seminare') || pathname.startsWith('/scan');
