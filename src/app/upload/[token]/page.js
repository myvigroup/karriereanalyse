      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', maxWidth: 400 }}>
          ...
          <p style={{ color: '#86868b', lineHeight: 1.6 }}>
            Dein Lebenslauf wurde erfolgreich hochgeladen. Dein Karriere-Coach sieht ihn jetzt und kann dir direkt Feedback geben.
          </p>
          <p style={{ color: '#86868b', fontSize: 14, marginTop: 16 }}>
