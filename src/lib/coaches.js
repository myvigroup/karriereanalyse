...
export const COACHES = [
  ...
  },
  {
    ...
    seminarIds: ['sem-typgerecht', 'sem-worklife'],
    masterclassIds: [],
  },
  {
    id: 'alexander-zill',
    ...
    seminarIds: ['sem-speedreading', 'sem-homeoffice', 'sem-knigge'],
    masterclassIds: [],
  },
  {
    id: 'florian-fritsch',
    ...
    seminarIds: ['sem-achtsamkeit', 'sem-kommunikation', 'sem-rhetorik'],
    masterclassIds: ['soon-karriere-grundlagen'],
  },
  {
    id: 'mario-jatzke',
    name: 'Mario Jatzke',
  ...
  },
  {
    ...
    seminarIds: ['sem-konflikt', 'sem-motivation', 'sem-leadership'],
    masterclassIds: [],
  },
  {
    id: 'julia-jacob',
    ...
    seminarIds: [],
    masterclassIds: ['soon-gehaltsverhandlung', 'soon-vg-fragen'],
  },
  {
    id: 'mario-blumwerk',
    name: 'Mario Blumwerk',
    role: 'Finanz-Coach · Partner',
    title: 'Externer Partner · powered by IFI',
    initials: 'MaB',
    gradient: 'linear-gradient(135deg, #2d5d3a 0%, #163420 100%)',
    photoUrl: null,
    status: 'available',
    sinceYear: 2024,
    experience: 'Finanz-Bildungs-Spezialist',
    rating: 5.0,
    sessionCount: 0,
    responseTime: '< 12 Std',
    location: 'extern · powered by IFI',
    languages: ['Deutsch'],
    short: 'Geldmindset & Finanzielle Intelligenz — gemeinnütziger Bildungspartner.',
    bio: `Mario Blumwerk verantwortet die Inhalte zum Thema Geldmindset und Finanzielle Intelligenz im Karriere-Institut Portal. Sein Beitrag ist powered by **IFI — Institut für Finanzielle Intelligenz**, einem gemeinnützigen Verein, der praxisnahe Finanzbildung für Berufstätige vermittelt.`,
    successStory: '',
    specialties: ['Geldmindset', 'Finanzielle Intelligenz', 'Vermögensaufbau'],
    industries: ['alle Branchen'],
    slots: [],
    seminarIds: [],
    masterclassIds: ['soon-finanzielle-intelligenz'],
    external: true,
